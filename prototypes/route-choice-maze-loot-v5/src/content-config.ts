...
export interface SpecialCollectionConfig extends TreasureConfig {
  chapter: number;
  sourceHint: string;
}
...
// 章节特殊收藏使用独立刷新池，不参与普通宝物权重抽取。
export const SPECIAL_COLLECTION_CONFIG: SpecialCollectionConfig[] = [
  { name: '王名圈金印', icon: '🔏', rarity: 'legend', w: 2, h: 2, value: 4800, weight: 1, chapter: 1, sourceHint: '金字塔：宝藏房、储物间、章节 BOSS', description: '刻有胡夫王名圈的纯金印玺' },
  { name: '太阳船星盘', icon: '🧭', rarity: 'legend', w: 3, h: 2, value: 5200, weight: 1, chapter: 1, sourceHint: '金字塔：宝藏房、储物间、章节 BOSS', description: '用于校准太阳船航向的祭仪星盘' },
  { name: '冥界审判羽', icon: '🪶', rarity: 'mythic', w: 2, h: 3, value: 13500, weight: 1, chapter: 1, sourceHint: '金字塔：宝藏房、储物间、章节 BOSS', description: '传说可衡量亡者心脏重量的神羽' },

  { name: '翡翠长历盘', icon: '🗓️', rarity: 'legend', w: 3, h: 3, value: 5400, weight: 1, chapter: 2, sourceHint: '玛雅神庙：诅咒祭坛、精英房、章节 BOSS', description: '以整块翡翠雕刻的长纪历法盘' },
  { name: '羽蛇神祭刃', icon: '🗡️', rarity: 'legend', w: 2, h: 3, value: 5800, weight: 1, chapter: 2, sourceHint: '玛雅神庙：诅咒祭坛、精英房、章节 BOSS', description: '刀脊镶嵌绿松石羽片的祭祀短刃' },
  { name: '血月祭司冠', icon: '🌙', rarity: 'mythic', w: 3, h: 3, value: 15000, weight: 1, chapter: 2, sourceHint: '玛雅神庙：诅咒祭坛、精英房、章节 BOSS', description: '只在血月仪式中佩戴的最高祭司冠' },

  { name: '错金虎符', icon: '🐯', rarity: 'legend', w: 2, h: 2, value: 6000, weight: 1, chapter: 3, sourceHint: '秦陵地宫：深层宝藏房、无伤清房、章节 BOSS', description: '通体错金、阴阳两半严丝合缝的兵符' },
  { name: '玄鸟玉璧', icon: '🐦', rarity: 'legend', w: 3, h: 2, value: 6500, weight: 1, chapter: 3, sourceHint: '秦陵地宫：深层宝藏房、无伤清房、章节 BOSS', description: '刻有玄鸟降生纹样的墨色玉璧' },
  { name: '祖龙不死诏', icon: '📜', rarity: 'mythic', w: 4, h: 2, value: 18000, weight: 1, chapter: 3, sourceHint: '秦陵地宫：深层宝藏房、无伤清房、章节 BOSS', description: '以金丝书写、追求万世不朽的密诏' },
];
